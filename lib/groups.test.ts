...
describe("teacher's review groups view", () => {
  it("the demo group carries one shared note about why it formed", () => {
    ...
    // The live group's union (tickets 278, 281): every problem a member did not get right, Liam's unfinished and never-reached ones included.
    expect(g1.discussing).toEqual(["q1", "q2", "q3", "q5", "q6", "q7", "q8", "q9", "q10"]);
  ...
  it("other groups are static and get a note of their own", () => {
    ...
    expect(groups[1].discussing).toEqual(["q3", "q4", "q5", "q6", "q7", "q8", "q10"]);
