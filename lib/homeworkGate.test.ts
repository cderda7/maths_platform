...
import { classHomeworks, futureHomeworks, homeworkColumn, homeworkForSet, homeworkOpened, homeworkSets, openHomeworks, openHomeworksFor, psetDueNote } from "./homeworks";
...
describe("opening (ticket 292)", () => {
  ...
  it("past its due date it leaves To do (missed, ticket 290)", () => {
    const c = endLesson(send(psetSent()));
