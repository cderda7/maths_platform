 ...
 * `pset-2` likewise is the real Problem Set 2 — Rationalising and expanding with surds (ticket 212), so no old
 * id is left: the map is empty, nothing redirects, and only the old seeded titles are still renamed.
 */
