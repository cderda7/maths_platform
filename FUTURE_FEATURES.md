...
A phase-by-phase review of the student lesson, checked against the evidence each phase rests on. Its individual review point (tier the detective disclosure) is the section above. The rest follows. None is scoped or ticketed yet: each changes a core rule of an existing phase and needs Carson's call.
