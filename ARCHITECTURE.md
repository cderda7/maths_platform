...
| 42 | Progress bar, leaderboard and medals | `/board` race and held standings, `/teacher` card, `/student` group bar | _this commit_ | [curr_version/architecture/42-progress-bar-leaderboard-medals.md](curr_version/architecture/42-progress-bar-leaderboard-medals.md) |
