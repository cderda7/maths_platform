...
const RECORDS: Classmate[] = [
  ...
  light("mia", "Mia Nguyen", "MN", "low: fractions, non-monic factorising", 10, ["q2", "q7", "q9"], [{ text: "a factor pair never expanded back", problems: ["q2"] }, { text: "the third off by a third", problems: ["q7"] }, { text: "took −x out and left the sign behind", problems: ["q9"] }], { q9: Q9_SIGN }, "I keep guessing the brackets instead of checking. With the fractions I lost track of which terms I had scaled. In Q9 I took the x out and didn't notice the sign inside the bracket had to change."),
  ...
  light("oliver", "Oliver Brennan", "OB", "low: factorising", 7, ["q1", "q2", "q3", "q7"], [{ text: "factor pairs not expanded back", problems: ["q1", "q2"] }, { text: "null factor law on a product that isn't 0", problems: ["q3"] }, { text: "scaled two of three terms", problems: ["q7"] }], { q1: Q1_PAIR }, "Factorising is the bit I'm not sure of, so I guess and hope. I didn't know the null factor law only works for zero. In Q7 I multiplied the x terms by 3 and left the 8 over 3 as it was."),
  ...
  light("sofia", "Sofia Petrov", "SP", "confident", 10, ["q2", "q4", "q7"], [{ text: "a factor pair not checked", problems: ["q2"] }, { text: "denominator a, not 2a", problems: ["q4"] }, { text: "scaled two of three terms", problems: ["q7"] }], {}, "The fractions in Q4 threw me and I lost the 2, and in Q7 I only cleared the ones in front of x. In Q2 I guessed the pair and moved on."),
];
