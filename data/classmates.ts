 ...
 *
 * The shape of the wrongs (ticket 130): 45 wrong student-problem entries. Q7 has twelve
 * classmates wrong across three strategies (six cleared the fraction from two terms, four
 * multiplied through and lost the third, two took the third out and then the wrong pair);
...
const Q7_LOST_THIRD = ["x^2 + 6x + 8", "2 \\times 4 = 8,\\quad 2 + 4 = 6", "(x + 2)(x + 4)"];
...
export const CLASSMATES: Classmate[] = [
  ...
  light("ethan", "Ethan Kowalski", "EK", "low", 8, ["q1", "q4", "q7", "q9"], [{ text: "signs flipped in the factors", problems: ["q1"] }, { text: "divided by a, not 2a", problems: ["q4"] }, { text: "multiplied through by 3 and never took it back out", problems: ["q7"] }, { text: "axis given as the height, a step skipped", problems: ["q9"] }], { q7: Q7_LOST_THIRD, q9: Q9_RUSHED }, "I was rushing on Q9 and went straight to the height. On Q4 I always forget the 2 under the line. In Q7 I got rid of the fractions and never put the third back."),
  ...
  light("sofia", "Sofia Petrov", "SP", "low: fractions", 10, ["q2", "q4", "q7"], [{ text: "guessed a factor pair", problems: ["q2"] }, { text: "denominator a, not 2a", problems: ["q4"] }, { text: "scaled two of three terms", problems: ["q7"] }], {}, "The fractions in Q4 threw me and I lost the 2, and in Q7 I only cleared the ones in front of x. In Q2 I guessed the pair and moved on."),
];
