 ...
 * group's board is now ten problems, five and a half minutes at the quickest (every peer turn as scripted, Sam
 ...
 * violet 9 · sky 10, the live group's row unread).
 */
export const RACE_SCHEDULE: Record<GroupColour, number[]> = {
  ...
  sky: [45, 95, 150, 200, 250, 300, 350, 400, 440, 480],
};
