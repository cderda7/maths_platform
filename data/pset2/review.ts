...
/**
 * What review made of Problem Set 2's problems (tickets 244, 281): the second submissions written in individual review
...
export const PS2_REVIEW: SetReview = {
  ...
  groups: {
    ...
    mint: { [q(1)]: rework(1), [q(2)]: rework(2), [q(3)]: rework(3), [q(8)]: rework(8), [q(9)]: rework(9), [q(10)]: MINT_Q10 },
