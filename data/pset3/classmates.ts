...
const SAM: Classmate = {
  ...
  wrong: [q(8)],
  notes: [{ text: "the pair's signs swapped", problems: [q(8)] }],
...
const CLASSMATES: Classmate[] = [
  ...
  },
  {
    ...
    wrong: [q(6), q(8), q(9)],
    notes: [
      { text: "a factor pair that multiplies to the constant, the brackets wrong", problems: [q(8), q(9)] },
      { text: "a perfect square factorised as a difference of squares", problems: [q(6)] },
    ],
  ...
  },
  {
    ...
    notes: [
      { text: "the second bracket's signs wrong multiplying", problems: [q(1)] },
      { text: "the middle term's sign wrong", problems: [q(2), q(6)] },
  ...
  },
  {
    ...
    wrong: [q(4), q(9)],
    notes: [
      { text: "factor brackets wrong", problems: [q(9)] },
      { text: "x² − 49 written as (x − 7)²", problems: [q(4)] },
    ],
  ...
  },
  {
    ...
    wrong: [q(5), q(8)],
    notes: [{ text: "a factor's sign flipped writing the pair, the check's result wrong", problems: [q(5), q(8)] }],
  ...
  },
  {
    ...
    wrong: [q(9)],
    notes: [{ text: "non-monic brackets wrong", problems: [q(9)] }],
