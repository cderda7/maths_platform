...
export default function Brand() {
  return (
    <Link href="/" className="flex items-center gap-2 text-accent font-medium tracking-tight">
      <BrandMark />
      <span className="text-[17px] text-accent-deep">Edexia</span>
      <span className="text-ink-muted text-[13px] font-normal ml-1 hidden sm:inline">· Maths</span>
    </Link>
  );
}
