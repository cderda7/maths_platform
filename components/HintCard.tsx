 ...
 * through" pill (`onTalk`) that opens the help chat on this hint. Practice problems (the warm-up, Q**
 * and the older mid-set practice), a set question once the student is back on it after practice on it
 * (ticket 312; never before), and the group whiteboard after a second wrong check (ticket 221, no linked
 * words).
 */
