...
/** The presenter's demo chooser: the iPad, the teacher view, the board and the one-tab split. It was `/` until ticket 265, which gave `/` to the teacher's Edexia Classroom. */
