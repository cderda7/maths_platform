...
/** The site's front page: the presenter's chooser of the iPad, the teacher view, the board and the one-tab split. Ticket 265 had moved it to `/demo` and redirected `/` to `/teacher`; ticket 286 brings it back to `/`, and `/demo` redirects here. */
    ...
    <div className="min-h-screen hero-glow">
      ...
      <main className="mx-auto max-w-5xl px-6 pt-10 pb-20">
        ...
        <p className="mt-5 max-w-2xl text-[17px] leading-relaxed text-ink-soft">
          ...
          <em>{DEMO_DRAFT_TITLE}</em> on the iPad, the teacher's laptop moves with them; the board wakes for class review.
        </p>
        ...
        <div className="mt-12 grid gap-6 md:grid-cols-3">
          <Link href="/student" className="group">
            <Card className="flex h-full flex-col p-7 transition-shadow group-hover:shadow-lift">
              ...
              <div className="mt-auto pt-6 text-[14px] font-medium text-accent-deep group-hover:underline" data-card-open>Open the iPad →</div>
            </Card>
          </Link>
          <Link href="/teacher" className="group">
            <Card className="flex h-full flex-col p-7 transition-shadow group-hover:shadow-lift">
              ...
              <div className="mt-auto pt-6 text-[14px] font-medium text-accent-deep group-hover:underline" data-card-open>Open the teacher view →</div>
            </Card>
          </Link>
