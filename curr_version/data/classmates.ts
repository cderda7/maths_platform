...
export const CLASSMATES: Classmate[] = [
  ...
  { id: "amelia", name: "Amelia Chen", initials: "AC", confidence: "low", done: 10, when: "2:30 pm", wrong: ["q6", "q10"], note: "Read “touches once” as Δ > 0; said the graph crosses twice.", attempts: { q6: Q6_TWICE, q10: Q10_TWICE }, groupStatus: "Quick pass done · comparing Q4 methods" },
