...
export const CLASSMATES: Classmate[] = [
  ...
  light("mia", "Mia Nguyen", "MN", "low: fractions, non-monic factorising", 10, "4:02 pm", ["q2", "q7"], [{ text: "guessed a factor pair, never expanded back", problems: ["q2"] }, { text: "the third off by a third", problems: ["q7"] }]),
  ...
  light("lucas", "Lucas Tanaka", "LT", "low: discriminant, graph features", 10, "4:00 pm", ["q6", "q10"], [{ text: "read “touches once” as Δ > 0", problems: ["q6"] }, { text: "negative discriminant, two solutions", problems: ["q10"] }]),
