...
export const CLASSMATES: Classmate[] = [
  ...
  { id: "zara", name: "Zara Haddad", initials: "ZH", confidence: "confident", done: 10, wrong: ["q3", "q9"], notes: [{ text: "null factor law on a product that isn’t 0", problems: ["q3"] }, { text: "axis given as the height", problems: ["q9"] }], attempts: { q3: Q3_NFL, q9: Q9_HEIGHT }, clarification: "I set each bracket equal to 6 because that's what was on the other side. And in Q9 I wrote the axis down and thought that was the height.", groupStatus: "Discussing Q3 · when the null factor law applies" },
  { id: "liam", name: "Liam O'Connell", initials: "LO", confidence: "confident", done: 2, wrong: ["q2", "q3"], notes: [{ text: "guessed a factor pair without expanding back", problems: ["q2", "q3"] }], attempts: { q2: Q2_GUESSED, q3: Q3_NFL }, clarification: "I ran out of time so I guessed the brackets. I know expanding back would have shown me.", groupStatus: "Discussing Q2 · listening" },
  ...
  light("lucas", "Lucas Tanaka", "LT", "low: discriminant, graph features", 10, ["q6", "q10"], [{ text: "read “touches once” as Δ > 0", problems: ["q6"] }, { text: "negative discriminant, two solutions", problems: ["q10"] }], {}, "I think I have the discriminant signs backwards. Touching once felt like it should be the bigger one."),
  ...
  light("harper", "Harper Singh", "HS", "confident", 6, ["q5", "q9"], [{ text: "turning point's height from the wrong line", problems: ["q5"] }, { text: "axis given as the height, jumped straight to it", problems: ["q9"] }], { q5: Q5_HEIGHT, q9: Q9_RUSHED }, "I substituted into the factorised line instead of the original. On Q9 I thought x = 3 was the answer."),
  light("oliver", "Oliver Brennan", "OB", "low: factorising", 7, ["q1", "q2", "q3"], [{ text: "guesses factor pairs without expanding back", problems: ["q1", "q2"] }, { text: "null factor law on a product that isn't 0", problems: ["q3"] }], {}, "Factorising is the bit I'm not sure of, so I guess and hope. I didn't know the null factor law only works for zero."),
  light("ruby", "Ruby Castellanos", "RC", "confident", 10, ["q5", "q9"], [{ text: "turning point's height from the wrong line", problems: ["q5"] }, { text: "axis given as the height", problems: ["q9"] }], { q5: Q5_HEIGHT }, "I found the axis of symmetry and then read the height off the wrong line both times."),
  light("finn", "Finn Dlamini", "FD", "confident", 10, ["q4", "q5"], [{ text: "divided by a, not 2a", problems: ["q4"] }, { text: "turning point's height from the wrong line", problems: ["q5"] }], { q5: Q5_HEIGHT }, "For the formula I divided by a. For the turning point I substituted into the wrong equation."),
  light("sofia", "Sofia Petrov", "SP", "low: fractions", 10, ["q2", "q4"], [{ text: "guessed a factor pair", problems: ["q2"] }, { text: "denominator a, not 2a", problems: ["q4"] }], {}, "The fractions in Q4 threw me and I lost the 2. In Q2 I guessed the pair and moved on."),
];
