...
| `app/teacher/ForceSubmit.tsx` | The card: "Hand in for everyone" (disabled once the live student is past working) → confirmation "N still working · 1 minute to finish" → pending state "Handing in · 0:59" with Cancel |
